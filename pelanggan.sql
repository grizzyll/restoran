...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 26, 2023 at 04:08 AM
...
CREATE TABLE `kasir` (
  ...
  `status_kasir` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `kasir` (`id_kasir`, `nama_kasir`, `status_kasir`) VALUES
(1, 'mandaalika', 'aktif'),
(2, 'felisitas', 'tidak aktif');
